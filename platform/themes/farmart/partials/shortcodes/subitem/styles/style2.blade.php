<section class=" shortcode-customer shortcode-customer-subitem shortcode-customer-subitem-style-2 py-4"
    ...
    <div class="container">
        ...
        @endif
        <div class="row row-cols-xxl-3 row-cols-lg-3 row-cols-md-2 row-cols-1 justify-content-center g-4">
